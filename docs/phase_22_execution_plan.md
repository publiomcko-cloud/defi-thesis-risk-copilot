...
| Repository regression | Full PostgreSQL/backend/frontend/browser/Compose/security/Phase 19 suite and exact-head hosted checks | `VERIFIED` locally; hosted result `PENDING` | Green required hosted results on the final Phase 22 PR SHA. |
