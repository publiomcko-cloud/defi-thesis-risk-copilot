...
- [`phase_19_threat_model.md`](phase_19_threat_model.md) and [`phase_19_evidence_matrix.md`](phase_19_evidence_matrix.md) — Phase 19A–19G risk and evidence record;
...
V1 Phase 19 — In progress; 19A–19G observability, limiter, edge/upload, monitoring, recovery-verification, supply-chain, and incident-response foundations implemented locally
