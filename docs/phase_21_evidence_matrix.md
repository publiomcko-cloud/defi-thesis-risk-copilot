...
| 21B Evaluation/routing | Implemented | Reversible `0030 -> 0031 -> 0030 -> 0031` SQLite and PostgreSQL cycles; checked-in public/synthetic 14-case `report_synthesis_public_v1`; immutable dataset identity, completed runs, case checksums/metrics, route history, and transitions; `report_synthesis.promotion.v1` hard safety/integrity thresholds; explicit platform-admin promotion/rollback only; one lockable active assignment per task/version/environment; exact adapter/model identity and private/org privacy gates; 21A route/evaluation provenance references; no-route/mismatch/provider/policy deterministic fallback. Real PostgreSQL simultaneous-promotion and promotion-vs-rollback races pass with a consistent single assignment/history. No automatic promotion, browser authority, paid provider, or production activation. |
