...
The local JSON public retrieval path remains authoritative. Slices 18A–18F are
...
implemented. Public-corpus migration, frontend, evaluation, and cutover remain
in Slices 18G–18H.
