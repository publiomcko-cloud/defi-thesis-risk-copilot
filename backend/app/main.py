...
from app.api.routes_model_feedback import router as model_feedback_router
...
from app.api.routes_research_intelligence import router as research_intelligence_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(model_feedback_router, prefix="/api")
    ...
    app.include_router(research_intelligence_router, prefix="/api")
